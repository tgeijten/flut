...
{
template< typename T >
void compare( const vec3_<T>& v1, const scone::Vec3& v2, T e = numeric_const<T>::relaxed_epsilon() )
{
...
template< typename T >
void compare( const quat_<T>& q1, const scone::Quat& q2, T e = numeric_const<T>::relaxed_epsilon() )
{
